	...
	<div class="container">
		<div class="row">
			<div class="col-lg-2 text-center text-lg-start">
				<a href="/">
					<picture>
						<img src="<?php echo e(Voyager::image(setting('site.footer_logo'))); ?>" alt="finreview logo">
					</picture>
				</a>
			</div>
			<div class="col-lg-8">
			...
			<div class="col-lg-2">
				<div class="row">
					<div class="col-md-4 col-lg-12 text-center text-md-start text-lg-end">
						<a href="mailto:<?php echo e($email->value); ?>" class="email_footer"><?php echo e($email->value); ?></a>
					</div>
		...
		<div class="row f_2">
			...
			<div class="col-6 col-md-4 text-end text-md-center">
				<?php echo app('translator')->get('general.allRightsReserved'); ?>
			</div>
...
</footer><?php /**PATH C:\Users\jandos\Desktop\OpenServer\domains\finreview-fixed\resources\views/partials/footer.blade.php ENDPATH**/ ?>