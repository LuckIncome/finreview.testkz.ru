<div class="offcanvas offcanvas-top" tabindex="-1" id="search_block" aria-labelledby="offcanvasTopLabel">
	<div class="offcanvas-header align-items-center">
		<h5 id="offcanvasTopLabel">@lang('general.siteSearch')</h5>
		<button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
	</div>
	<div class="offcanvas-body">
		<form class="needs-validation" id="search" action="{{ route('search', []) }}" method="POST" novalidate>
			@csrf
			<input type="text" id="head_s" name="header_search" placeholder="@lang('general.enterSearchWord')" required="">
	...
	<div class="offcanvas-body">
		...
		<div class="menu_block_2">
			...
			<a href="{{setting('site.instagram_link')}}" target="_blank">
				<picture>
					<img src="{{ asset('assets/img/inst.svg') }}" alt="instagram">
				</picture>
			</a>
			<a href="{{setting('site.telegram_link')}}" target="_blank">
				<picture>
					<img src="{{ asset('assets/img/te.svg') }}" alt="telegram">
				</picture>
			</a>
			<a href="{{setting('site.facebook_link')}}" target="_blank">
				<picture>
					<img src="{{ asset('assets/img/fb.svg') }}" alt="facebook">
				</picture>
			</a>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="container head_1">
			<div class="row align-items-center">
				<div class="col-4">
					<a href="/">
						<img src="{{Voyager::image(setting('site.header_logo'))}}" alt="finreview logo" class="d-none d-md-block">
						<img src="{{Voyager::image(setting('site.mobile_header_logo'))}}" alt="finreview mobile logo" class="d-md-none">
					</a>
				</div>
				<div class="col-3 offset-2 search d-none d-lg-block">
					<form class="needs-validation" id="search" action="{{ route('search', []) }}" method="POST" novalidate>
						@csrf
						<input type="text" id="head_s" name="header_search" placeholder="@lang('general.siteSearch')" required="">
						<input type="submit" class="search_button">
						<div class="invalid-feedback">
							@lang('general.pleaseEnterSearchWord') ...
						</div>
				...
				<div class="col-4 col-md-2 offset-lg-1">
					<ul>
						@if(url()->current() == url('/') . "/" . $locale)
							<li>@if($locale == 'en') En @else <a href="/en">En</a> @endif</li>
							<li>@if($locale == 'kz') Kz @else <a href="/kz">Kz</a> @endif</li>
							<li>@if($locale == 'ru') Ru @else <a href="/ru">Ru</a> @endif</li>
						@else
							<li>@if($locale == 'en') En @else <a href="{{route('changeLang', 'en')}}">En</a> @endif</li>
							<li>@if($locale == 'kz') Kz @else <a href="{{route('changeLang', 'kz')}}">Kz</a> @endif</li>
							<li>@if($locale == 'ru') Ru @else <a href="{{route('changeLang', 'ru')}}">Ru</a> @endif</li>
						@endif
					</ul>
				</div>
		...
		<div class="container-fluid menu d-none d-lg-block">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-3">
						<a href="#" data-bs-toggle="modal" data-bs-target="#subscribe">@lang('general.subscribeTo')</a>
					</div>
